    ...
    foreach ($forms as $form) {
        ...
        foreach ($detailed_items as $index => $item) {
            ...
            $rows[] = [
                ...
                'item_status_display' => htmlspecialchars($display_status),
...
<head>
    ...
    /* Separator for each new form group */
    ...
    /* --- STATUS STYLES --- */
    .status.waiting_for_approval { background-color: var(--status-pending-solid); color: #333; } 
    ...
    .status.overdue, .status.returned_late { background-color: var(--status-overdue-solid); color: white; }
    .status.damaged { background-color: #343a40; color: white; }

    /* --- COLUMN STYLING (Adjusted for Separation) --- */
    ...
    @media (max-width: 992px) {
        ...
        /* Hide Staff Remarks for smaller desktop/tablet */
        .table thead th:nth-child(6), 
        .table tbody td:nth-child(6) { display: none; }
        
        /* Make table columns stack horizontally on mobile */
        ...
        /* Clear all borders inside the card/row wrapper */
        .table tbody tr.first-item-of-group td {
        ...
        /* Add labels using data-label attribute (mobile only) */
        .table td::before {
        ...
        .table tbody tr td:nth-child(1) .form-details::before {
            content: "Form ID";
            font-weight: 700;
            color: #6c757d;
        }
        .table tbody tr td:nth-child(1) .form-type {
            font-size: 1rem;
            font-weight: 600;
            color: var(--msu-red-dark);
        }
        
        .table tbody tr td:nth-child(2) { /* Item Borrowed */
            text-align: left !important;
            font-size: 1.1rem;
            font-weight: 700;
        }
        .table tbody tr td:nth-child(2)::before {
            content: "Item Borrowed";
        }
    }
    ...
    @media (max-width: 576px) {
        ...
        .table tbody tr td:nth-child(1) .form-details .form-type {
            margin-top: 5px;
        }
    }
</style>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <th style="width: 5%;">Staff Remarks</th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            foreach ($detailedItemRows as $row):
                ...
                $row_class = '';
                if ($row['item_status_class'] === 'overdue' || $row['item_status_class'] === 'returned_late' || $row['item_status_class'] === 'damaged') {
            ...
            ?>
                <tr class="<?= $row_class ?>">
                    ...
                    <td data-label="Borrow Date:"><?= htmlspecialchars($row["borrow_date"]) ?></td>
                    ...
                    <td class="remarks-col" data-label="Staff Remarks:">
